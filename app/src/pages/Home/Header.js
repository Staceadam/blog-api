    ...
    return (
        <section css={styles.section}>
            ...
            <div className="container" css={styles.container}>
                <h1>Hey! I'm a guy that does things. wow.</h1>
                <img src="http://www.fillmurray.com/350/350" alt="" css={styles.img} />
            </div>
        </section>
    );
}
